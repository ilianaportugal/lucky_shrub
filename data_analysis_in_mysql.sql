...
## Create Clients, Orders, Products and Addresses tables
...
## Task 1: Find how many sycamore trees have been sold over the following years 2020, 2021, 2022
...
## Task 2: Find information on all clients and the order that they placed in the years 2022 and 2021
# Required information is client id, contact number, street, county, order id, cost, date, and product name
...
## Task 3: Analyze sales performance of Patio slates product in the year 2021
## Do this by developing a function that inputs a ProductID and a year from which they can capture data and display the total quantity of the product sold in the given year
